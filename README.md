...
LifeMart Safety Bot — неофициальный инструмент модерации Telegram-сообщений для LifeMart. Проект объединяет несколько фильтров, мета-классификатор и политику принятия решений, позволяя автоматически выявлять спам и нежелательные объявления, снижать нагрузку на команду модерации и при этом сохранять контроль над качеством.
...
- Развитие набора правил и словарей Keyword 
- Добавить графики
- Разработать и внести мультичатовую архитектуру с функционалом первичной настройки
- Упростить интерфейс взаимодействия для новичков чтобы достичь максимально понятного и гибкого использования
- Расширение датасета.
- Ведение истории версий моделей.
